...
- **Favorites**: Click the star icon on any card to save it to your "Favorites" for quick access later.
- **Personal Phrases**: Add your own custom phrases by clicking the **+** button.
- **Support Tools**: Access built-in checklists and tools in the "Support Tools" section.
...
2. Look for the **Install** icon in the address bar (next to the star icon).
3. Click **Install**.
